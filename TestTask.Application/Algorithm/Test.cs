...
{
    internal class Test : HashAlgorithm
    {
        ...
        public Test(UInt32 polynomial, UInt32 seed, UInt32 XorOut = 0xFFFFFFFF, bool refIn = true, bool refOut = true)
        {
            if (!BitConverter.IsLittleEndian)
                throw new PlatformNotSupportedException("Не поддерживается на процессорах Big Endian");
